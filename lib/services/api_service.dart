...
class ApiService {
  ...
  /// Scrape multiple product URLs, score each, and return ranked results.
  Future<Map<String, dynamic>> batchAnalyzeDressUrls({
    ...
    try {
      ...
      final response = await _dio.post('/batch-scrape-dress', data: payload);
